...
export function CheckoutClient({ cardEnabled }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === "card" && order.paymentPageUrl) {
      window.location.assign(order.paymentPageUrl);
      return;
    }
  ...
  const submitLabel =
    paymentMethod === "card" ? t("payWithCard") : t("placeOrder");
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 pb-36 sm:py-12 sm:pb-12 lg:pb-12">
      ...
      <p className="mb-6 rounded-lg bg-bamboo/10 p-3 text-sm text-olive/70">
        {cardEnabled ? t("paymentIntro") : t("paymentNote")}
      </p>
            ...
            {cardEnabled ? (
              <div className="grid gap-3">
                ...
                >
                  ...
                  />
                  <CreditCard className="mt-0.5 h-5 w-5 shrink-0 text-bamboo" />
                  <span>
                ...
                >
                  ...
                  />
                  <Landmark className="mt-0.5 h-5 w-5 shrink-0 text-olive" />
                  <span>
