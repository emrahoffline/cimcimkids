...
export function AdminSidebar() {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 flex h-dvh w-[min(18rem,85vw)] shrink-0 flex-col bg-[#1a1f1a] text-white transition-transform duration-200 md:static md:z-auto md:h-full md:w-60 md:translate-x-0 ${
